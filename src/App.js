...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0x9D33fc2C898CBCd13662b289281Be0cd9b412d54";
const POINTS_EXCHANGE_ADDRESS  = "0x891571fd3B2F88f480ca3df517a7808B316e8022";
...
const deployRegularPoints = async (signer, name, symbol) => {
  ...
  try {
    ...
    console.log("RegularPoints 合约已部署到:", regularPoints.address);
      ...
      {!isWalletConnected ? (
        ...
        <div>
          ...
          <div>
            ...
            />
            <button onClick={handleDeploy}>部署普通积分发行合约</button>
          </div>
          ...
          <div>
            ...
            <p>兑换比例: 1 {symbol || 'RLP'} = {exchangeRate} UPT</p>
